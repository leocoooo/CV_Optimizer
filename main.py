...
def orchestrate_matching(cv_path: str):
    ...
    # Vous pouvez modifier les filtres (location, contract_type) directement ici pour vos tests
    logger.info("Recherche des meilleures offres en base...")
    results = matcher.find_matches(
        profile_text=cv_text,
        top_n=5,
        location="Paris",        # Ex: "Paris"
        contract_type="CDI",    # Ex: "CDI"
        experience="D"
    )

    # 4. Affichage simple des résultats
    print("\n" + "="*60)
