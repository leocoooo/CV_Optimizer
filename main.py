...
def match_cv_with_offers(cv_path: str, filters: dict = None):
    """
...
def run_pipeline(cv_path: str, keywords: list, mode: str = "quick", skip_collection: bool = False):
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        logger.error("Exemple: python main.py 'data/CVs/cv.pdf' 'Data Scientist,Machine Learning'")
        sys.exit(1)
