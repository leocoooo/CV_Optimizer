...
async def get_jobs(
    ...
    days_limit: int = Query(30, ge=1, le=365, description="Offres des N derniers jours"),
    ...
    **Exemple d'utilisation** :
    ...
    for job in jobs:
        ...
        job_response = JobResponse(
            ...
            actualisation_date=job.actualisation_date
        )
...
async def get_job_details(
    ...
    return JobResponse(
        ...
        company=job.company,
        location=job.location,
        description=job.description,  # Description complète
        contract_type=job.contract_type,
        required_experience=job.required_experience,
        url=job.url,
        source=job.source,
